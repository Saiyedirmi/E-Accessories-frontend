            ...
            <div className="row">
                <div className="col-12">
                    <div className="single-blog-card">
                        ...
                        <p>
                            You're only as good as your last collection, which is an enormous pleasure. I think there is something 
                            about luxury -it's not something people need, but it's what they want.
