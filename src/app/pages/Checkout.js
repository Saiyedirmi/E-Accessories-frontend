            ...
            <div className="row">
                <div className="col-7">
                    <div className="checkout-left-data">
                        <h3 className="website-name">E-Accessories</h3>
                        ...
                        aria-current="page">Information</li>
                        &nbsp; /
                        <li className="breadcrumb-item active">
                        Shipping
                        </li>
                        ...
                        <p className="user-details total">
                            Saiyed Irmi (saiyedirmi@gmail.com)
                        </p>
                ...
                <div className="col-5">
                    <div className="border-bottom py-4">
                        ...
                        <div className="w-75 d-flex gap-10">
                            <div className="w-25 position-relative">
                                <span
                                style={{ top: "-10px", right: "2px"}} className="badge bg-secondary text-white rounded-circle p-2 position-absolute">
                                    1
                                </span>
                                <img className="img-fluid" src="images/watch.jpg" alt="watch"/>
                            </div>
                            <div>
                                <h5 className="total-price">Kids watch 10 pack multi colored for students</h5>
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <p className="mb-0 total-price">$ 16.50</p>
                       
                    </div>
                    </div>
                    <div className="d-flex justify-content-between align-items-center border-bottom py-4">
                        <h4 className="total">Total</h4>
                        <h5 className="total-price">$ 116.50</h5>
